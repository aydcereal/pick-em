...
export default function PoolCardContainer(props) {
  ...
  console.log("Props.pools: ", props.pools);

  const [shouldHideStates, setShouldHideStates] = useState([]);
  const [poolName, setPoolName] = useState(undefined);

  useEffect(() => {
    // Check if props.pools is defined and is an array
    if (Array.isArray(props.pools)) {
  ...
  useEffect(() => {
    if (props.poolData) {
      setPoolName(props.poolData.poolName);
    }
  }, [props]); // Empty dependency array to run the effect only once
                    ...
                    <BottomContainerSlot>
                      <ActionsContainer>
                        <ActionsSubContainer>
                          ...
                          <FlyoutMoreActions
                            shouldHide={shouldHideStates[index]}
                            poolKey={pool.key}
                          ></FlyoutMoreActions>
                        </ActionsSubContainer>
                      </ActionsContainer>
            ...
            <PoolCardDefaultContainer>
              <TopContainer>
                <Container>
                  ...
                  <HeadingContainer>
                    <TitleContainer>
                      <Title>{poolName ? poolName : "Loading..."}</Title>
                    </TitleContainer>
                    <Category>NFL Pick 'em</Category>
                  </HeadingContainer>
                </Container>
