          ...
          <div className="poolRegister">
            <div className="step">
              ...
              <div className="settings">
                <label className="col-sm-2" htmlFor="pool_name">
                  Pool Name
                </label>
                ...
                <div>
                  <label className="col-sm-2" htmlFor="pool_format">
                    Pool Format
                  </label>
                  ...
                  >
                    ...
                    <PopoverBody>
                      ...
                      Pick winners and select one or more of your picks as a
                      'Best Bet' that is worth a set number of points
                      (configurable later).
                    </PopoverBody>
                    <PopoverBody>
                      <strong style={{ fontWeight: "bold", fontSize: "14px" }}>
                        Pick 'em with Confidence Points:{" "}
                      </strong>{" "}
                      Pick winners and rank your picks from 16-1 based on your
                      level of confidence. Receive those points for each win.
                    </PopoverBody>
                  </Popover>
                  <select
                    value={poolFormat}
                    onChange={(event) => setPoolFormat(event.target.value)}
                    name="formatId"
                    id="formatId"
                ...
                <div>
                  <label className="col-sm-2" htmlFor="pool_points">
                    Point Spreads
                  </label>
                  ...
                  >
                    ...
                    <PopoverBody>
                      Pick'em pools can be setup to include or ignore the games'
                      point spreads when calculating results.
                    </PopoverBody>
                  </Popover>
                  <select
                    value={pointSpreads}
                    onChange={(event) => setPointSpreads(event.target.value)}
                    name="spread_option"
                    class="form-select"
                  >
                    <option value="0">Not used in making picks</option>
                    <option value="2">
                      Used in making picks, set by RunYourPool
                    </option>
                    <option value="1">
                      Used in making picks, manually set by Commish
                    </option>
                  </select>
                </div>

                <div>
                  <label className="col-sm-2" htmlFor="pwd">
                    Starting Week
                  </label>
                  ...
                  >
                    ...
                    <PopoverBody>
                      This is the week that standings will start being
                      calculated for your pool.{" "}
                      <em style={{ fontStyle: "italic" }}>Note:</em> This
                      setting can no longer be changed once picks have been
                      made.
                    </PopoverBody>
                  </Popover>
                  <select
                    value={startingWeek}
                    onChange={(event) => setStartingWeek(event.target.value)}
                    name="starting_week"
                    class="form-select"
                  >
                ...
                <div className="visibility">
                  <label className="col-sm-2" htmlFor="pool_visibility">
                    Pool Visibility
                  </label>
                  <span
                    className="fa-help"
                    id="poolVisibilityHelp"
                    tabIndex="0"
                  >
                    <FontAwesomeIcon
                      icon={faQuestionCircle}
                  ...
                  >
                    ...
                    <PopoverBody>
                      This controls who can see your pool and who is allowed to
                      join it.
                    </PopoverBody>
                  </Popover>
                  <div>
                ...
                {privatePool ? (
                  <div id="txtPrivate">
                    ...
                    <ul class="small-text text-ul">
                      ...
                      <li>
                        You must accept any user that asks to join via your
                        invite link
                      </li>
                      <li>
                        Your pool will not automatically be visible to your
                        connections
                      </li>
                    </ul>
                  </div>
                  ...
                  <div id="txtPublic" class="small-text">
                    ...
                    <ul class="small-text small-text text-ul">
                      <li>
                        Visible to your connections and 1st connections of pool
                        members
                      </li>
